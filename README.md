...
* Eating a power pellet will temporarily turn the ghosts blue, allowing you to eat them for extra points.
...
* **`Frontend`**: This package contains all of the code related to the user interface and graphics.
    ...
    * `Sprite`: This directory contains the sprite sheets for the game.
    * `menu`: This directory contains the code for the game's menus.
...
* **`Backend`**: This package contains all of the game logic.
    ...
    * `Cases`: This directory contains the different types of squares that make up the game board.
    * `Entities`: This directory contains the classes for the game's characters (Pac-Man and the ghosts).
    * `global`: This directory contains global variables and constants.
